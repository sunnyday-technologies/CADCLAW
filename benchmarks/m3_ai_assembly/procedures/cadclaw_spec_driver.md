...
- The placed reference geometry includes the latest fixture constraints:
  inward Y C-Beam channels, X and Y C-Beams with the 80 mm side vertical,
  centered 2040 splice inserts in the X-gantry and top X-frame runs, 2080 lower
  Y rails, an open bottom in X, ZPMM top spacer/motor-mounts, lower flat frame
  spacers, and a 2040 top center spreader with its 40 mm side vertical and top
  face flush with the top frame.
