...
- The placed reference geometry includes the latest fixture constraints:
  ...
  internal 2040 X-gantry inserts, 2080 lower Y rails, an open bottom in X,
  ZPMM top spacer/motor-mounts, lower flat frame spacers, and a 2040 top center
  spreader with its 40 mm side vertical and top face flush with the top frame.
