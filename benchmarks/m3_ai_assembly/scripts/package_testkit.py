...
PACKAGE_PATHS = [
    ...
    "benchmarks/m3_ai_assembly/procedures/comparison_runbook.md",
    "benchmarks/m3_ai_assembly/procedures/native_cad_driver.md",
    "benchmarks/m3_ai_assembly/results/.gitkeep",
    "benchmarks/m3_ai_assembly/run_logs/README.md",
    "benchmarks/m3_ai_assembly/run_logs/initial_cadclaw_setup_2026_05.yaml",
    "benchmarks/m3_ai_assembly/run_logs/templates/run_log_template.yaml",
    ...
    "examples/m3_crete/generate_sequence_gifs.py",
